...
fn test_config_serialization_roundtrip() {
    ...
    assert_eq!(original_config.feeds[0].name, deserialized_config.feeds[0].name);
    assert_eq!(original_config.feeds[0].url, deserialized_config.feeds[0].url);
    assert_eq!(original_config.feeds[0].description, deserialized_config.feeds[0].description);
    assert_eq!(original_config.feeds[1].name, deserialized_config.feeds[1].name);
    assert_eq!(original_config.output.filename, deserialized_config.output.filename);
    assert_eq!(original_config.output.title, deserialized_config.output.title);
    assert_eq!(original_config.output.author, deserialized_config.output.author);
}
